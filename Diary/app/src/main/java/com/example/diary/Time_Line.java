...
public class Time_Line extends ConstraintLayout {
    ...
    private void initial_dialog(){
        confirm=new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface arg0,int arg1)
            {
                ...
                linearLayout.removeView(Time_Line.this);
            }
        };
    ...
    private void setData(){
        switch (Weather){
            case "Sunny" :{ Time_Line_BG.setImageResource(R.drawable.sunny); }break;
            case "Rainy" :{ Time_Line_BG.setImageResource(R.drawable.rain); }break;
            case "Cloudy" :{ Time_Line_BG.setImageResource(R.drawable.cloudy);}break;
            case "Overcast" :{ Time_Line_BG.setImageResource(R.drawable.overcast); }break;
        }
    ...
    public Time_Line(Context context, String date, String day, int diary_index, LinearLayout layout, Context app_context){
        super(context);
    ...
    public Time_Line(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public Time_Line(Context context, AttributeSet attrs, int defStyle) {
